...
const Chat: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Input */}
      <div className="fixed bottom-24 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-offwhite-300/50 px-6 py-4 shadow-gentle">
        <div className="max-w-sm mx-auto">
          <div className="flex items-end space-x-3">
            <div className="flex-1">
              <textarea
                ...
                className="w-full p-4 bg-offwhite-100/50 border border-offwhite-300 rounded-3xl resize-none focus:outline-none focus:ring-2 focus:ring-lavender-300 focus:border-transparent text-calm-800 placeholder-calm-400 max-h-24 text-sm leading-relaxed"
                rows={1}
              />
            </div>
            <button
              ...
              className="w-12 h-12 bg-gradient-to-r from-lavender-500 to-softblue-500 text-white rounded-full flex items-center justify-center shadow-gentle disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-soft hover:scale-105 active:scale-95"
            >
